...
Amazon Location Service Mobile Authentication SDK for Android is released under the [Apache license][license]. Any code you submit will be released under that
