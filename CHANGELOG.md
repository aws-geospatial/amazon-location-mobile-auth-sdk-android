...
- Add API key Android restrictions section to README
- Add Android headers to AwsSignerInterceptor and restore MapHttpClientProvider
- Add MapHttpClientProvider for MapLibre transform request support
