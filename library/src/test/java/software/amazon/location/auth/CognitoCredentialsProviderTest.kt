...
class CognitoCredentialsProviderTest {
    ...
    fun setUp() {
        ...
        mockCall = mockk()
        mockResponse = mockk()
        cognitoCredentialsProvider = CognitoCredentialsProvider("us-east-1")
        cognitoCredentialsProvider.client = mockClient
    }
    ...
    fun `test getIdentityId`() = runBlocking {
        ...
        val result = cognitoCredentialsProvider.getIdentityId("us-east-1:xxxxxx-xxxx-xxxx-xxxxx-xxxxxxxxxx")
    ...
    fun `test getCredentials`() = runBlocking {
        ...
        val result = cognitoCredentialsProvider.getCredentials("us-east-1:xxxxxx-xxxx-xxxx-xxxxx-xxxxxxxxxx")
